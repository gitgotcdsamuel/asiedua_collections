// lib/home/widgets/pages/shoes.dart
...
class _ShoesPageState extends State<ShoesPage> {
  ...
  final String _categoryName = 'Shoes';
        ...
        actions: [
          IconButton(
            icon: Container(
              ...
              child: const Icon(Icons.filter_list_rounded, color: Color(0xFF96CEB4)),
            ),
  ...
  List<Product> _applyFilters(List<Product> products) {
    ...
    if (_selectedGender != 'all') {
      filtered = filtered.where((p) {
        final name = p.name.toLowerCase();
        final desc = p.description.toLowerCase();
        return name.contains(_selectedGender) || desc.contains(_selectedGender);
      }).toList();
    }
          ...
          Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: const Color(0xFF96CEB4).withOpacity(0.3)),
              ),
              child: Column(
                children: [
                  Container(
                  ...
                  Text(
                    'Unable to load shoes collection',
                    style: GoogleFonts.raleway(
                      fontSize: 14,
              ...
              child: Column(
                children: [
                  SvgPicture.asset(
                    ...
                    height: 80,
                    width: 80,
                    color: const Color(0xFF96CEB4).withOpacity(0.5),
                  ),
                  const SizedBox(height: 20),
                  Text(
                    'No Shoes Found',
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'New shoe arrivals are coming soon.',
                    style: GoogleFonts.raleway(
                      fontSize: 15,
                      fontWeight: FontWeight.w400,
                      color: Colors.grey.shade600,
                  ...
                  if (_inStockOnly || _selectedFilter != 'all')
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.white,
                        foregroundColor: const Color(0xFF96CEB4),
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(12),
                          side: const BorderSide(color: Color(0xFF96CEB4)),
                        ),
                        padding: const EdgeInsets.symmetric(
                          horizontal: 32,
                          vertical: 12,
  ...
  Widget _buildCategoryBanner(int? totalCount) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF96CEB4).withOpacity(0.2),
            blurRadius: 25,
            spreadRadius: 2,
  ...
  Widget _buildFilterChips(int? totalCount) {
    final filters = ['all', 'sneakers', 'heels', 'flats', 'boots', 'sandals', 'loafers'];
    final filterLabels = {
      'all': 'All',
      'sneakers': 'Sneakers',
      'heels': 'Heels',
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: FilterChip(
                    ...
                    selectedColor: const Color(0xFFF5FFFA),
                    checkmarkColor: const Color(0xFF96CEB4),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(20),
                      side: BorderSide(
                        color: isSelected ? const Color(0xFF96CEB4) : Colors.grey.shade300,
        ...
        children: [
          ...
          Stack(
            children: [
              ...
              // Category badge
              if (product.name.toLowerCase().contains('sneaker') || product.description.toLowerCase().contains('sneaker'))
                Positioned(
                  top: 12,
                  left: 12,
                  child: Container(
