// lib/home/widgets/pages/bags.dart
...
class _BagsPageState extends State<BagsPage> {
  ...
  final String _categoryName = 'Bags';
        ...
        actions: [
          IconButton(
            icon: Container(
              ...
              child: const Icon(Icons.filter_list_rounded, color: Color(0xFFFFD166)),
            ),
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Unable to load bags collection',
                    style: GoogleFonts.raleway(
                      fontSize: 14,
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'We\'re adding new bags to our collection soon.',
                    style: GoogleFonts.raleway(
                      fontSize: 15,
                      fontWeight: FontWeight.w400,
                      color: Colors.grey.shade600,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Elegant & Functional Collections',
                  style: GoogleFonts.raleway(
                    fontSize: 15,
  ...
  Widget _buildFilterChips(int? totalCount) {
    final filters = ['all', 'handbag', 'clutch', 'tote', 'backpack', 'wallet'];
    final filterLabels = {
      'all': 'All',
      'handbag': 'Handbags',
      'clutch': 'Clutches',
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: FilterChip(
                    ...
                    checkmarkColor: const Color(0xFFFFD166),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(20),
                      side: BorderSide(
                        color: isSelected ? const Color(0xFFFFD166) : Colors.grey.shade300,
        ...
        children: [
          ...
          Stack(
            children: [
              ...
              // Stock badge
              if ((product.stockCount ?? 0) <= 3 && (product.stockCount ?? 0) > 0)
                Positioned(
                  top: 12,
                  left: 12,
                  child: Container(
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: isSelected ? const Color(0xFFFFFBF0) : Colors.grey.shade50,
              borderRadius: BorderRadius.circular(12),
              border: Border.all(
            ...
            child: Row(
              children: [
                Icon(
                  icon,
                  size: 20,
                  color: isSelected ? const Color(0xFFFFD166) : Colors.grey.shade600,
                ),
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Container(
            padding: const EdgeInsets.all(16),
            decoration: BoxDecoration(
              color: _inStockOnly ? const Color(0xFFFFFBF0) : Colors.grey.shade50,
              borderRadius: BorderRadius.circular(12),
              border: Border.all(
                color: _inStockOnly ? const Color(0xFFFFD166) : Colors.transparent,
                width: 1.5,
              ),
            ),
            child: Row(
              children: [
                Icon(
                  ...
                  size: 20,
                  color: _inStockOnly ? const Color(0xFFFFD166) : Colors.grey.shade600,
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: Text(
